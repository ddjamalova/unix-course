---
layout: lesson
title: Unix course – Introduction to basic Unix commands
root: .
permalink: index.html 
date: '2025-04-23'
---

During this tutorial you will use many unix commands. Your task is to **identify** 
...
The first two sections (part 1 and 2) describe how to access the workshop environment for this tutorial.
